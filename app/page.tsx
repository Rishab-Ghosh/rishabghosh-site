        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center content-slide-in">
            ...
            <h1 className="heading-artistic mb-6">
              ...
              <br />
              <span className="text-highlight animate-float font-display">I&apos;m Rishab</span>
            </h1>

            {/* Subheading */}
            <p className="subheading-artistic text-text/80 mb-8 leading-relaxed">
              Finance • Amateur Builder • Cinephile • Poker
            </p>

            {/* Bio */}
            <p className="body-artistic text-text/70 max-w-3xl mx-auto mb-12 leading-relaxed">
            ...
            <div className="content-slide-up" style={{animationDelay: '0.1s'}}>
              <Link href="/reviews" className="block">
                <div className="card-artistic group">
                  ...
                  <h3 className="text-2xl font-heading font-semibold text-primary mb-4 group-hover:text-gradient transition-all duration-500">
                    Movie Reviews
                  </h3>
